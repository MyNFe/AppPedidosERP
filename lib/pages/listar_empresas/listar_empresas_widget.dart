              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Column(
                    mainAxisSize: MainAxisSize.max,
                    children: [
                      FutureBuilder<List<ListaEmpresasRow>>(
                        future: SQLiteManager.instance.listaEmpresas(),
                        builder: (context, snapshot) {
                          ...
                          final listViewListaEmpresasRowList = snapshot.data!;

                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewListaEmpresasRowList.length,
                            itemBuilder: (context, listViewIndex) {
                              final listViewListaEmpresasRow =
                                  listViewListaEmpresasRowList[listViewIndex];
                              return Container(
                                width: 100.0,
                                height: 100.0,
                                decoration: BoxDecoration(
                                  ...
                                  children: [
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 10.0, 0.0, 0.0),
                                      child: Text(
                                        listViewListaEmpresasRow.codigo,
                                    ...
                                    Padding(
                                      padding: const EdgeInsetsDirectional.fromSTEB(
                                          0.0, 10.0, 0.0, 0.0),
                                      child: Text(
                                        listViewListaEmpresasRow.razao,
                                        style: FlutterFlowTheme.of(context)
                                            .bodyMedium
                                            .override(
                                              fontFamily: 'Plus Jakarta Sans',
                      ...
                      Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('AdicionarCliente');
                          },
                          text: 'Consulta API CLIENTES',
